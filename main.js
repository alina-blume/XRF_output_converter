	...
	function handleFiles() {
		...
		reader.onload = function(evt) {
			...
			elementMittelwert(evt.target.result);
			}
            else if (document.getElementById('Ox').checked) {
			oxideMittelwert(evt.target.result);
			}
			else {
				alert("'Element' oder 'Oxid' muss ausgewählt sein");
			}
        }
	...
	var test2 = "2020_06_19Element	Bescheibung	Methode	Auswertung	Na	Na	Mg	Mg	Al	Al	Si	Si	P	P	S	S	Cl	Cl	K	K	Ca	Ca	Ti	Ti	V	V	Cr	Cr	Mn	Mn	Fe	Fe	Co	Co	Ni	Ni	Cu	Cu	Zn	Zn	Ga	Ga	Ge	Ge	As	As	Se	Se	Br	Br	Rb	Rb	Sr	Sr	Y	Y	Zr	Zr	Nb	Nb	Mo	Mo	Ag	Ag	Cd	Cd	Sn	Sn	Sb	Sb	Te	Te	I	I	Cs	Cs	Ba	Ba	La	La	Ce	Ce	Pr	Pr	Nd	Nd	Er	Er	Yb	Yb	Hf	Hf	Ta	Ta	W	W	Hg	Hg	Tl	Tl	Pb	Pb	Bi	Bi	Th	Th	U	U	Summenkonzentration	Einheit				mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	mg/kg	Abs. Fehler ( mg/kg)	%	"
	var test ="2020_06_19Element	Bescheibung	Methode	Auswertung	Na	Na	Mg	Mg	Al	Al	Si	Si	P	P	S	S	Cl	Cl	K	K	Ca	Ca	Ti	Ti	V	V	Cr	Cr	Mn	Mn	Fe	Fe	Co	Co	Ni	Ni	Cu	Cu	Zn	Zn	Ga	Ga	Ge	Ge	As	As	Se	Se	Br	Br	Rb	Rb	Sr	Sr	Y	Y	Zr	Zr	Nb	Nb	Mo	Mo	Ag	Ag	Cd	Cd	Sn	Sn	Sb	Sb	Te	Te	I	I	Cs	Cs	Ba	Ba	La	La	Ce	Ce	Pr	Pr	Nd	Nd	Er	Er	Yb	Yb	Hf	Hf	Ta	Ta	W	W	Hg	Hg	Tl	Tl	Pb	Pb	Bi	Bi	Th	Th	U	U	Summenkonzentration	Einheit				%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	Abs. Fehler ( %)	%	"
	
	console.log(test2.length);
	console.log(test.length);
	console.log(header_El.length);
	
	function elementMittelwert (uploadedData){
...
function oxideMittelwert (uploadedData){
		processData(uploadedData);	
